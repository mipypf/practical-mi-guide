...
- Google Colabの仕様変更に伴い、ライブラリをインストールするセルを実行した際に、Google Colab上で「ランタイムを再起動してください」といったポップアップが表示されることがあります。 その際は案内に従ってランタイムを再起動し、**もう一度ライブラリインストールのセルを実行**してください。
...
|:-|:-|:-|
| EDA | データの概要を把握する | [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/mipypf/practical-mi-guide/blob/develop/chapter3/src/EDA.ipynb) |
| baseline_image_density | 目的変数：画像濃度を対象に機械学習モデルを構築 | [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/mipypf/practical-mi-guide/blob/develop/chapter3/src/baseline_image_density.ipynb) |
| baseline_scratch_resistance | 目的変数：耐擦過性を対象に機械学習モデルを構築  | [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/mipypf/practical-mi-guide/blob/develop/chapter3/src/baseline_scratch_resistance.ipynb) |
| baseline_surface_tension | 目的変数：表面張力を対象に機械学習モデルを構築 | [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/mipypf/practical-mi-guide/blob/develop/chapter3/src/baseline_surface_tension.ipynb) |
| baseline_viscosity | 目的変数：粘度を対象に機械学習モデルを構築| [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/mipypf/practical-mi-guide/blob/develop/chapter3/src/baseline_viscosity.ipynb) |
| test_data_analysis | 実験候補点を可視化して確認する | [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/mipypf/practical-mi-guide/blob/develop/chapter3/src/test_data_analysis.ipynb) |
...
| image_segmentation | 深層学習を用いた画像セグメンテーションを行うサンプル | [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/mipypf/practical-mi-guide/blob/develop/chapter4/src/image_segmentation.ipynb) |
...
| screening_of_organic_materials | 有機材料のスクリーニングを行うサンプル | [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/mipypf/practical-mi-guide/blob/develop/chapter4/src/screening_of_organic_materials.ipynb) |
...
| feature_generation_cif | CIFから無機材料の特徴量を生成するサンプル | [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/mipypf/practical-mi-guide/blob/develop/chapter4/src/feature_generation_cif.ipynb) |
| visualization_of_inorganic_materials | 無機材料の構造可視化を行うサンプル | [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/mipypf/practical-mi-guide/blob/develop/chapter4/src/visualization_of_inorganic_materials.ipynb) |
| visualization_xrd_map | X線回折パターンから構造の分類を行うサンプル | [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/mipypf/practical-mi-guide/blob/develop/chapter4/src/visualization_xrd_map.ipynb) |
| time_series_analysis | 時系列センサーデータの予測のサンプル | [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/mipypf/practical-mi-guide/blob/develop/chapter4/src/time_series_analysis.ipynb) |
...
| bayesian_optimizaition_sample_proof_stress | リストベースアプローチとベイズ最適化を組み合わせたサンプル | [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/mipypf/practical-mi-guide/blob/develop/chapter5/src/bayesian_optimizaition_sample_proof_stress.ipynb) |
